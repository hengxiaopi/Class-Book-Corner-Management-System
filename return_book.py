...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.stu_name = QtWidgets.QComboBox(Form)
        self.stu_name.setGeometry(QtCore.QRect(70, 15, 181, 21))
    ...
    def commit_info(self):
        with open("return_info.txt","w",encoding="utf-8") as f:
            f.write(self.stu_name.currentText())
        self.finish=True
        self.form.close()

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        data=eval(open("return_info.txt","r",encoding="utf-8").read())
        Form.setWindowTitle(_translate("Form","班级图书角管理系统"))
        self.label.setText(_translate("Form","归  还 人："))
...
if __name__ == '__main__':
    ...
    app.exec_()
    if not ui.finish:
        open("return_info.txt","w",encoding="utf-8").write("None")